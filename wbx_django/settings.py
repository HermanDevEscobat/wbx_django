"""
Django settings for wbx_prj project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                # Тут кат проц
                'wbx_app.context_processors.categories_processor',
...
WSGI_APPLICATION = 'wbx_django.wsgi.application'
